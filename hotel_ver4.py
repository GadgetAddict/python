# AARON TOMTE -  HOTEL CALCULATIONS - PYTHON 3
    ...
    while True:
        ...
        try:
            ...
            while maxRooms is None and user_input > 0:
                #print(f"TEST MODE: Returning input: " , user_input)
                return user_input
            else:
...
for floor in range(1,totalFloors+1):
	if floor == 13:
		...
		# Add Zero to the lists so that the list contains the right amount of elements
